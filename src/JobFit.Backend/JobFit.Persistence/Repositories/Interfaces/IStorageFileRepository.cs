...
/// <summary>
/// Defines repository functionality for managing storage files.
/// </summary>
public interface IStorageFileRepository
{
    ...
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    /// <returns>Updated file if soft deleted, otherwise null</returns>
    ...
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    /// <returns>Updated file if soft deleted, otherwise null</returns>
    ValueTask<StorageFile?> DeleteAsync(StorageFile file, CommandOptions commandOptions = default,
        CancellationToken cancellationToken = default);
}